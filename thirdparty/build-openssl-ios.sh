...
cd $(dirname $0)/openssl-ios
rm -rf ${ROOT}/_install_ios/lib/thirdparty/libopenssl.xcframework
...
./build.sh iphonesimulator arm64
...
echo "${OPENSSL_CURRENT_VERSION}" > "${OPENSSL_BUNDLE}/VERSION"
